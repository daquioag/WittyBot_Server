...
export const Ok = 'ok';
export const USER_NOT_FOUND_BY_ID = (id: number) => `User with ID ${id} not found.`;
export const ERROR_INCREMENTING_API_COUNT = (id: number) => `Error incrementing API count for user ID ${id}:`;
